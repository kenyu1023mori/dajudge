...
# CSVファイルの読み込み
input_file_path = "/home/group4/data/filtered_by_shareka_cleaned.csv"
...
score_ranges = [(1.0, 1.9, 3000), (2.0, 2.9, 3000), (3.0, 3.9, 3000), (4.0, 4.9, 3000)]
sampled_data = []
...
for score_min, score_max, sample_size in score_ranges:
    ...
    if len(filtered_data) < sample_size:
        sample_size = len(filtered_data)  # サンプルサイズを調整
